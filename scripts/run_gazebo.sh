...
do  
# run REMO
python /home/spacex/melodic_workspace/DORF/main.py --dataset=gazebo --seq=${dir_set[$i]} --config_path /home/spacex/melodic_workspace/DORF/config/gazebo.yaml --n_proc=1
