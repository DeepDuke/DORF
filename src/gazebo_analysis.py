...
def calc_naive_preservation(gt, estimate, dists, indices, voxelsize):
    ...
    # DETERMINISTIC_INLIER_THR = np.Inf
    ...
    num_preserved = num_pc 
    gt_inliers = gt_sem_label[:]
    est_inliers = est_sem_label[:]
...
def evaluate(gt, estimate, voxelsize=0.2):
    ...
    print('num_preserved = {}, num_static_preserved = {}, num_dynamic_preserved = {}'.format(num_preserved, num_static_preserved, num_dynamic_preserved))
    # Print metrics
...
if __name__ == "__main__":
    ...
    parser.add_argument('--gt', default='/home/spacex/melodic_workspace/IROS2023/REMO_WS/src/REMO/map/05_2350_to_2670_w_interval2_voxel_0.200000.pcd', type=str)
    parser.add_argument('--est', default='/home/spacex/melodic_workspace/IROS2023/REMO_WS/src/REMO/test/seq_05_static_map.pcd', type=str)
